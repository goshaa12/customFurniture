...
export const heroData: HeroData = {
  ...
  imageSrc: "/images/home/children-beds.webp",
};

// Константы для Services компонента
export const servicesData: ServicesData = {
  title: "О нас",
  subtitle: "С 2011 года мы изготавливаем детскую мебель на заказ, которая сочетает комфорт, безопасность и стиль.\n\nКаждое изделие создаётся под рост, интерьер и привычки ребёнка — будь то письменный стол для школьника или творческое место для малыша.\n\nМы продумываем всё до мелочей: материалы, фурнитуру и эргономику, чтобы ребёнку было удобно, а вам спокойно.",
};
...
export const reUsableTableData2: ReUsableTableData = {
  ...
  table: {
    columns: [
      { key: "product", header: "Вид стола" },
      { key: "description", header: "Описание" },
      { key: "price", header: "Цена от (тг)" },
    ],
    rows: [
      {
        product: "Для творчества",
...
export const reUsableTableData3: ReUsableTableData = {
  ...
  subtitle: "Правильная высота стола — основа здоровой осанки и комфорта детей.\n\nПодбирайте мебель не по возрасту, а по росту — ведь дети растут по-разному, и разница в несколько сантиметров уже влияет на посадку и осанку.",
  table: {
    columns: [
      { key: "criterion", header: "Рост ребёнка (см)" },
      { key: "description", header: "Оптимальная высота (см)" },
    ],
    rows: [
      {
        criterion: "100–115",
